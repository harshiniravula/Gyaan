...
class Button extends Component {
   ...
   btnCss = () => {
      ...
      const { rectangular, pill, round, curved } = buttonShapes
      switch (shape) {
         case rectangular:
   ...
   render() {
      ...
      const { filled, outline } = buttonTypes
      switch (type) {
         case filled:
            return <BaseButton {...other} btnCss={this.btnCss} />
         case outline:
            return <OutlineButton {...other} btnCss={this.btnCss} />
         default:
